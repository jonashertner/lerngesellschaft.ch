...
## Bookings configuration completed

- The exact German acknowledgement above was saved to **Lektion anfragen → Benachrichtigungen → Zusätzliche Informationen hinzufügen** and verified by reopening. It augments Microsoft's default confirmation email. The public on-screen acknowledgement has no wording editor in the inspected settings; the standard Microsoft wording remains. No live booking or test email was created.
- Jonas subsequently requested an October 2026 launch and bookable lessons from **12 October 2026**. Existing weekly availability, staff, one-hour duration, 24-hour lead time and 365-day horizon remain. A date-specific **Nicht buchbar** exception covers 15 September through 11 October 2026 inclusive. Reopening confirmed persistence; a separate public-calendar inspection confirmed all earlier dates disabled and 12 October as the first available date with the seven Monday slots.
- Service location is **Münsterplatz 17, 4051 Basel**. Because Microsoft's public service details did not display the saved location field, the service description also retains the existing lead verbatim and adds **Ort: Münsterplatz 17, 4051 Basel.** This makes the address available before booking.
