...
Diese Probe ist so wirksam, weil sie das Memorieren zwingt, sich zu zeigen.[^abruf] Wenn man einer Anfängerin erklärt, was man gelernt hat, fallen alle Stellen auf, an denen man nur die Worte hat und nicht die Sache. Man stockt. Man greift zu Begriffen, die selbst der Erklärung bedürften. Man kann eine Rückfrage nicht beantworten, weil man die Antwort selbst nie hatte, sondern nur die richtige Vokabel. In diesem Stocken zeigt sich, was man nicht verstanden hat — und genau hier beginnt die nächste Lerneinheit.

Die Einzelstunde ist der ideale Ort für diese Probe, weil die Tutorin die Anfängerin spielen kann, ohne eine Anfängerin zu sein. Sie weiss, was eine quadratische Gleichung ist. Aber sie kann fragen, als wüsste sie es nicht, und die Schülerin muss erklären, als spräche sie zum ersten Mal davon. In diesem Spiel — das in einer ganzen Klasse kaum möglich ist — kommen die Lücken ans Licht. Sie kommen ohne Beschämung ans Licht, weil sie in einer Situation erscheinen, in der das Stocken in Ordnung ist. Beim Erklären *darf* man stocken; beim Prüfen darf man es nicht. Genau dieser Unterschied ist das Geschenk, das die Tutorin neben die Schule stellen kann.
...
Dann geht es an die Sache. Die Sache ist immer eine konkrete: eine Mathematikaufgabe, ein deutscher Text, eine englische Übersetzung, ein Geschichtsthema, das vorbereitet werden muss. Doch die Tutorin geht sie nicht so durch, dass sie erklärt und das Kind zuhört. Die Tutorin fragt, und das Kind erklärt. *Was glaubst du, was hier verlangt ist? Wenn du es einer Drittklässlerin erklären würdest, wie würdest du anfangen? Wo genau wird es für dich unklar?* Diese Fragen sind die eigentliche Arbeit. Wenn das Kind sie beantworten kann, hat es die Sache schon halb verstanden, und die andere Hälfte ergibt sich oft im Gespräch. Wenn es sie nicht beantworten kann, dann beginnt der Unterricht — und beginnt nicht beim Lehrstoff, sondern dort, wo das Kind tatsächlich steht.
...
[^abruf]: Die Wirksamkeit dieser Probe ist in der Lernforschung gut belegt. Drei Befunde laufen zusammen. Erstens der *Abrufeffekt* (testing effect): Wer Wissen aktiv abruft, behält es zuverlässiger als wer es noch einmal liest. Vgl. Henry L. Roediger / Jeffrey D. Karpicke, «Test-Enhanced Learning: Taking Memory Tests Improves Long-Term Retention», *Psychological Science* 17/3 (2006), 249–255, sowie Jeffrey D. Karpicke / Janell R. Blunt, «Retrieval Practice Produces More Learning than Elaborative Studying with Concept Mapping», *Science* 331/6018 (2011), 772–775. Zweitens der *Selbsterklärungseffekt*: Wer in eigenen Worten erklärt, *warum* etwas der Fall ist, lernt mehr als wer dieselben Texte stumm liest. Vgl. Michelene T. H. Chi et al., «Self-Explanations: How Students Study and Use Examples in Learning to Solve Problems», *Cognitive Science* 13/2 (1989), 145–182, sowie die Metaanalyse von Asheena Bisra et al., «Inducing Self-Explanation: A Meta-Analysis», *Educational Psychology Review* 30/3 (2018), 703–725. Drittens die *Illusion erklärender Tiefe*: Menschen überschätzen, wie gut sie Mechanismen verstehen, bis sie sie tatsächlich erklären sollen. Vgl. Leonid Rozenblit / Frank Keil, «The Misunderstood Limits of Folk Science: An Illusion of Explanatory Depth», *Cognitive Science* 26/5 (2002), 521–562. Die genannten Studien betreffen vor allem ältere Schülerinnen und Studierende; sie weisen aber denselben Mechanismus aus, den die Tutorin in der Einzelstunde sichtbar macht.
